...
object ConverterNetModels {

    fun convertToImages(imagesModel: ImagesModel): Images {
        return Images(
            large = Large(
    ...
    private fun convertToIngredients(ingredientModel: IngredientModel): Ingredient {
        return Ingredient(
    ...
    fun convertToRecipes(model: RecipeSearchModel): List<Recipe> {
    ...
    fun convertToRecipe(model: RecipeModel?): Recipe {
        return Recipe(
